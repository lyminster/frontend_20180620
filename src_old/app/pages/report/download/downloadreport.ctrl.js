...
(function () {
    ...
    angular.module('BlurAdmin.pages.report')
        .controller('downloadreportctrl', downloadreportctrl);

    /** @ngInject */
    function downloadreportctrl($state, $window, authService, ngAuthSettings, reportService, $scope, $filter, toastr, editableOptions, editableThemes, managequestionaireService, manageparticipantService) {
        var vm = this;
        ...
        vm.gridQuestionaire = {
            ...
            columnDefs: [
                ...
                {
                    name: 'action', enableFiltering: false, cellTemplate: '<div style="display: flex;align-items: center;justify-content: center;"><button type="button" title="download pica" ng-click="grid.appScope.vm.downloadrow(row.entity)" class="btn btn-success  btn-xs"><i class="ion-ios-cloud-download"></i></button></div>', width: 100
                },
