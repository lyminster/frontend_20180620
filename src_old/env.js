(function (window) {
  ...
  // // API url Development
  // // window.__env.serviceAPIBase = 'http://surveyaiwebapi.azurewebsites.net/';
  // // AUTH url Development
  // // window.__env.serviceBase = 'http://surveyaiwebapi.azurewebsites.net/';
  
  // // URL SSO Astra
  // // window.__env.serviceSsoBase = 'https://devproxy.astra.co.id/hsohome/#/login';
