...
(function () {
    ...
    angular.module('BlurAdmin.pages.report')
        .controller('downloadrowctrl', downloadrowctrl);
  
    /** @ngInject */
    function downloadrowctrl($state, ngAuthSettings, authService, $window, reportService, $scope, $filter, toastr, editableOptions, editableThemes, managequestionaireService, manageparticipantService) {
        var vm = this;
