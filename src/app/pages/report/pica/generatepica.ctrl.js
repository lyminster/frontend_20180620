    ...
    function generatepicactrl($state,  $window, authService, ngAuthSettings, $stateParams, $scope, $filter, toastr, editableOptions, editableThemes, managequestionaireService, manageparticipantService, reportService) {
        ...
        vm.gridPica = {
            ...
            columnDefs: [
                ...
                { name: 'tipeLayanan', displayName: "Tipe Layanan", width: 50 , enableCellEdit: false},
                ...
                { name: 'rootCause', displayName: "Root Cause", width: 300, cellTemplate: '<textarea type="text" name="reasons" style="color: black;background: #f2f2f2;resize: none;" class="col-sm-8 form-control" ng-model="row.entity.rootCause"></textarea>' , enableCellEdit: false},
