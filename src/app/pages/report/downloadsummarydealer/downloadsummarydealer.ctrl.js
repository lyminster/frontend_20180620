...
(function () {
    ...
    angular.module('BlurAdmin.pages.report')
        .controller('downloadsummarydealerctrl', downloadsummarydealerctrl);

    /** @ngInject */
    function downloadsummarydealerctrl($state, reportService, authService, $scope, $filter, toastr, editableOptions, editableThemes, managequestionaireService, manageparticipantService, $window, ngAuthSettings) {
        var vm = this;
