...
(function () {
  ...
  function routeConfig($stateProvider, $urlRouterProvider) {
    $stateProvider
      ...
      .state('report.downloadrating', {
        url: '/downloadrating',
        templateUrl: 'app/pages/report/downloadrating/downloadrating-report.html',
        title: 'Download Rating',
        controller: 'downloadratingctrl',
        controllerAs: 'vm',
        sidebarMeta: {
          order: 204,
        },
      })
      .state('report.downloadsummarydealer', {
        url: '/downloadsummarydealer',
        templateUrl: 'app/pages/report/downloadsummarydealer/downloadsummarydealer-report.html',
        title: 'Download Summary Dealer',
        controller: 'downloadsummarydealerctrl',
        controllerAs: 'vm',
        sidebarMeta: {
          order: 205,
        },
