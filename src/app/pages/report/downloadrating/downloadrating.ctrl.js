...
(function () {
    ...
    angular.module('BlurAdmin.pages.report')
        .controller('downloadratingctrl', downloadratingctrl);

    /** @ngInject */
    function downloadratingctrl($state, reportService, authService, $scope, $filter, toastr, editableOptions, editableThemes, managequestionaireService, manageparticipantService, $window, ngAuthSettings) {
        var vm = this;
