...
(function () {
  ...
  angular
    .module("BlurAdmin.pages.managequestionaire")
    .controller("createquestionairectrl", createquestionairectrl);

  /** @ngInject */
  function createquestionairectrl(
    $state,
    $scope,
    $uibModal,
    toastr,
    ...
    vm.general.region =
      authService.authentication.mainDealerCode +
      " - " +
      authService.authentication.mainDealerName;
    ...
    //tambahan dari rommy 16 okt 2019
    //tambahan menu multiple choise

    vm.getAllKabupaten = function () {
