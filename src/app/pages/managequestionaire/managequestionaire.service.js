...
(function () {
    ...
    angular.module('BlurAdmin.pages.managequestionaire')
        .factory('managequestionaireService', ['$http', 'ngAuthSettings', function ($http, ngAuthSettings, $localForage) {
            ...
            managequestionaireServiceFactory.dealertype = function () {
                return $http.post(serviceBase + 'api/questionnaire/post/dealertype').then(function (results) {
                    return results;
                });
            };
            // add sales customer sales type
            managequestionaireServiceFactory.getSalesType = function () {
                return $http.get(serviceBase + 'api/questionnaire/get/custsalestype').then(function (results) {
                    return results;
                });
            };
            managequestionaireServiceFactory.postRelateddealerBlm = function (distrik, type) {
                return $http.post(serviceBase + 'api/questionnaire/post/filterrelateddealer?KabID=' + distrik + '&dealerType=' + parseInt(type) + '').then(function (results) {
                    return results;
                });
            };
            ...
            managequestionaireServiceFactory.checkboxdcsl = function () {
                return {
                    dataForm: {
                        "uuid": guid(),
